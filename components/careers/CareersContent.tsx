...
const roles = [
  ...
  },
  {
    ...
    type: "Full-time",
    descriptionUs: "Recruit, onboard, and retain top-tier professional chauffeurs. You'll build the supply side of our marketplace.",
    descriptionPk: "Recruit, onboard, and retain top-tier professional drivers. You'll build the supply side of our marketplace.",
  },
  {
            ...
            {roles.map(role => (
              <div key={role.title}
                ...
                <p className="mt-3 text-sm leading-6 text-gray-500">
                  {role.descriptionUs ? (isPk ? role.descriptionPk : role.descriptionUs) : role.description}
                </p>
              </div>
            ))}
          </div>
