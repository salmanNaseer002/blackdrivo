...
const coverage = [
  {
    ...
    logo: "Forbes",
    date: "March 2025",
    headlineUs: "How BlackDrivo is Redefining Premium Ground Transportation in the Tri-State Area",
    headlinePk: "How BlackDrivo is Redefining Premium Ground Transportation in Lahore, Karachi, and Islamabad",
    category: "Business",
    href: "#",
  },
  {
    ...
    logo: "WSJ",
    date: "January 2025",
    headlineUs: "BlackDrivo's Tech-First Approach to Luxury Chauffeur Service Gains Traction",
    headlinePk: "BlackDrivo's Tech-First Approach to Luxury Driver Service Gains Traction",
    category: "Technology",
    href: "#",
  },
  {
    ...
    logo: "TC",
    date: "November 2024",
    headlineUs: "BlackDrivo Raises Series A to Expand Its On-Demand Chauffeur Platform",
    headlinePk: "BlackDrivo Raises Series A to Expand Its On-Demand Driver Platform",
    category: "Funding",
    href: "#",
  },
  {
    ...
    logo: "BI",
    date: "September 2024",
    headlineUs: "Inside the Startup Disrupting Executive Transportation One Ride at a Time",
    category: "Profile",
    href: "#",
  },
  {
    ...
    logo: "NJ",
    date: "July 2024",
    headlineUs: "New Jersey's BlackDrivo Makes Premium Car Service Accessible to All Travelers",
  ...
  },
  {
    ...
    logo: "T+L",
    date: "May 2024",
    headlineUs: "The Best Black Car Services in New York and New Jersey, Ranked",
    category: "Travel",
    href: "#",
  },
];
...
export default function PressContent() {
  ...
  const stats = isPk ? statsPk : statsUs;
      ...
      <section className="px-4 py-20 md:px-6 lg:px-8">
        <div className="mx-auto max-w-[1600px]">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {coverage.map(item => (
              <a key={item.headlineUs} href={item.href}
                ...
                <p className="mt-4 flex-1 text-base font-semibold leading-snug text-gray-900 group-hover:text-[#0b66d1] transition">
                  {isPk && item.headlinePk ? item.headlinePk : item.headlineUs}
                </p>
