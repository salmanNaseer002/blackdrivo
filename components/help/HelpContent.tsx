...
import {
  ...
  Phone, Mail, ArrowRight, ChevronRight,
} from "lucide-react";
...
const faqs: { section: string; id: string; items: { q: string; aUs: string; aPk?: string }[] }[] = [
  {
    section: "Bookings",
    id: "bookings",
    items: [
      {
        ...
        aUs: "We recommend booking at least 2 hours ahead for standard rides. For airport pickups, corporate events, or group travel, booking 24 hours in advance ensures driver availability.",
      },
      {
        q: "Can I book a ride for someone else?",
        aUs: "Yes. During checkout enter the passenger's name and contact number. Your payment method is used for the booking and the passenger receives pickup updates directly.",
      },
      {
        q: "How do I modify or cancel my booking?",
        aUs: "Log into your account and visit My Bookings. You can modify pickup time or location up to 2 hours before the ride. Cancellations made more than 1 hour before pickup are fully refunded.",
      },
      {
        q: "What happens if I need to change my pickup time last minute?",
        aUs: "Contact us via phone or WhatsApp and we will do our best to accommodate. Changes within 60 minutes of pickup may incur a small adjustment fee.",
      },
      {
        q: "Is there a minimum booking time?",
        aUs: "Hourly bookings start at a minimum of 2 hours. One-way and airport transfer bookings have no minimum duration — you pay only for your trip.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        aUs: "Your card is authorized at booking and charged after the ride is completed. The final amount reflects the actual trip including any tolls, wait time, or extras.",
      },
      {
        q: "What payment methods do you accept?",
        aUs: "We accept all major credit and debit cards via Stripe. Corporate accounts can arrange invoiced billing with net payment terms.",
      },
      {
        q: "Are there any hidden fees?",
        aUs: "No. Your quoted fare includes the base rate, standard tolls, and driver gratuity. Any extras (parking, airport fees, extended wait) are shown clearly before you confirm.",
      },
      {
        q: "How do I get a receipt?",
        aUs: "A detailed receipt is emailed automatically after each completed ride. You can also download receipts from the Payments section of your account.",
      },
      {
        q: "What is the cancellation refund policy?",
        aUs: "Cancellations more than 1 hour before pickup receive a full refund. Cancellations within 60 minutes of pickup or no-shows are charged a 50% fee.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        aUs: "We offer four classes: Business (premium sedans), First Class (luxury sedans), SUV (large SUVs for groups up to 6), and Van (for larger groups or extra luggage).",
      },
      {
        q: "How much luggage can I bring?",
        aUs: "Business and First Class vehicles accommodate 2 standard checked bags. SUV and Van accommodate 4–6 bags. Need more space? Note it in Special Requests at booking.",
      },
      {
        q: "Is there a wait time allowance at airports?",
        aUs: "Yes. Domestic arrivals include 60 minutes of complimentary wait. International arrivals include 90 minutes. Additional waiting time is charged at the posted hourly rate.",
      },
      {
        q: "Does the driver track my flight?",
        aUs: "Yes. All airport transfers include live flight tracking. If your flight is delayed or lands early, your driver adjusts automatically with no action needed from you.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        aUs: "Every BlackDrivo chauffeur passes a comprehensive background check, DMV records review, in-person interview, and vehicle inspection before their first trip.",
        aPk: "Every BlackDrivo driver passes a comprehensive background check, DMV records review, in-person interview, and vehicle inspection before their first trip.",
      },
      {
        q: "Are vehicles insured?",
        aUs: "Yes. All vehicles in our network are fully commercially insured for passenger transportation. Coverage details are available on request.",
      },
      {
        q: "Can I share my trip with someone?",
        aUs: "Yes. From My Bookings, tap Share Trip to send a live link with your driver details and real-time location to any contact.",
      },
    ],
  },
];
                ...
                {section.items.map(item => (
                  <details key={item.q}
                    ...
                    <p className="mt-3 text-sm leading-7 text-gray-600">
                      {isPk && item.aPk ? item.aPk : item.aUs}
                    </p>
                  </details>
                ))}
              </div>
